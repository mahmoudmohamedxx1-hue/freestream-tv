...
export const PROVIDERS: Provider[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    description: 'Curated top 100 per genre — 810 verified working channels',
    flag: '🏆',
    categories: [
      { id: 'sports', name: 'Sports (100✓)', flag: '⚽', directUrl: '/curated/sports.m3u' },
      { id: 'news', name: 'News (100✓)', flag: '📰', directUrl: '/curated/news.m3u' },
      { id: 'movies', name: 'Movies (100✓)', flag: '🎬', directUrl: '/curated/movies.m3u' },
