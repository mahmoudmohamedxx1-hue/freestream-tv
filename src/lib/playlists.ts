    ...
    categories: [
      {
        ...
        flag: '🏆',
        playlists: [
          { id: 'premier-league', name: '🦁 Premier League (21✓)', flag: '🦁', url: '/leagues/premier-league.m3u' },
          { id: 'la-liga', name: '🇪🇸 La Liga (3✓)', flag: '🇪🇸', url: '/leagues/la-liga.m3u' },
          { id: 'serie-a', name: '🇮🇹 Serie A (27✓)', flag: '🇮🇹', url: '/leagues/serie-a.m3u' },
          { id: 'champions-league', name: '🏆 Champions League (5✓)', flag: '🏆', url: '/leagues/champions-league.m3u' },
          { id: 'europa-league', name: '🥈 Europa League (12✓)', flag: '🥈', url: '/leagues/europa-league.m3u' },
          { id: 'world-cup-2026', name: '🏆 World Cup 2026 (50✓)', flag: '🏆', url: '/leagues/world-cup-2026.m3u' },
          { id: 'nfl', name: '🏈 NFL (7✓)', flag: '🏈', url: '/leagues/nfl.m3u' },
          { id: 'nba', name: '🏀 NBA (3✓)', flag: '🏀', url: '/leagues/nba.m3u' },
          { id: 'mlb', name: '⚾ MLB (2✓)', flag: '⚾', url: '/leagues/mlb.m3u' },
          { id: 'nhl', name: '🏒 NHL (1✓)', flag: '🏒', url: '/leagues/nhl.m3u' },
          { id: 'ufc-mma', name: '🥊 UFC & MMA (26✓)', flag: '🥊', url: '/leagues/ufc-mma.m3u' },
          { id: 'f1-racing', name: '🏎️ F1 & Motorsport (11✓)', flag: '🏎️', url: '/leagues/f1-racing.m3u' },
